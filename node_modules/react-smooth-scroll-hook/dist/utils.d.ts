...
export declare type DirectionType = Direction | 'x' | 'y';
export declare type AttrMapType = {
...
export declare const getAttrMap: (direction: DirectionType) => AttrMapType;
export declare function debounce(cb: Function, delay?: number): (...args: any) => void;
export declare const isWindowScrollParent: (elm: HTMLElement) => boolean;
